...
2. ~~**Разбор партии**~~ ✅  
3. Адаптивная сила, eval-бар, подсказки тренера, дебютная книга, материалы

Подробный план по этапам, критерии готовности и риски — в **[ROADMAP.md](./ROADMAP.md)**.  
С него можно продолжить разработку в любой момент.
...
- Ничья всегда принимается ботом (режим тренировки на стороне продукта ещё в roadmap).  
